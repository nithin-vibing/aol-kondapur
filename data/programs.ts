...

  {
    ...
    batches: [
      // ─── ADD / EDIT BATCHES HERE ──────────────────────────────
      {
        ...
        timing_weekend: null,
        schedule: [
          { label: 'Offline · Fri 15 May', timing: '5:00 PM – 8:30 PM' },
          { label: 'Offline · Sat & Sun, 16–17 May', timing: '10:00 AM – 1:00 PM' },
          { label: 'Offline · Mon 18 May', timing: '5:00 PM – 8:00 PM' },
          { label: 'Online · 19–25 May (daily)', timing: '30 min, evening' },
        ],
        language: 'English',
        mode: 'Offline',
        venue: null,
      ...
      },
      {
        ...
        timing_weekend: null,
        schedule: [
          { label: 'Module 1 · 20–23 Apr', timing: '4:30 PM – 6:30 PM' },
          { label: 'Module 2 · 27–29 Apr', timing: '5:30 PM – 7:30 PM' },
          { label: 'Module 3 · 06 May', timing: '5:30 PM – 7:30 PM' },
        ],
        language: 'English',
        mode: 'Offline',
        venue: null,
      ...
      },
      {
        ...
        timing_weekend: null,
        schedule: [
          { label: 'Module 1 · 20–23 Apr', timing: '6:30 PM – 8:30 PM' },
          { label: 'Module 2 · 27–29 Apr', timing: '5:30 PM – 7:30 PM' },
          { label: 'Module 3 · 06 May', timing: '5:30 PM – 7:30 PM' },
        ],
        language: 'English',
